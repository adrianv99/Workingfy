...
CREATE TABLE `cliente` (
  `id` int(11) NOT NULL COMMENT 'Clave única del registro de cliente',
  `nombre` varchar(50) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Nombre del cliente ',
  `apellido` varchar(50) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Apellido del cliente',
  `correo` varchar(50) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Correo electronico del cliente',
  `telefono` varchar(50) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Numero de teléfono del cliente ',
  `cedula` varchar(50) COLLATE utf8_spanish_ci NOT NULL COMMENT 'identificacion legal del cliente',
  `direccion` varchar(100) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Lugar de residencia del cliente',
  `contrasena` varchar(50) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Clave de acceso al sistema del cliente',
...
CREATE TABLE `freelancer` (
  `id` int(11) NOT NULL COMMENT 'Clave única del registro de freelancer',
  `nombre` varchar(50) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Nombre del freelancer',
  `apellido` varchar(50) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Apellido del freelancer',
  `correo` varchar(50) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Correo electrónico del freelancer',
  `telefono` varchar(50) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Numero de teléfono del freelancer',
  `cedula` varchar(50) COLLATE utf8_spanish_ci NOT NULL COMMENT 'identificacion legal del freelancer',
  `direccion` varchar(100) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Lugar de residencia del freelancer',
  `contrasena` varchar(50) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Clave de acceso al sistema del freelancer',
  `rating` float NOT NULL COMMENT 'Calificación de los trabajos hechos por el freelancer',
  `id_profesion` int(11) NOT NULL COMMENT 'Profesión que posee el freelancer',
...
CREATE TABLE `interesado` (
  `id` int(11) NOT NULL COMMENT 'Clave única del registro del interesado',
  `id_freelancer` int(11) NOT NULL COMMENT 'Freelancer interesado en trabajar en el proyecto',
...
CREATE TABLE `profesion` (
  `id` int(11) NOT NULL COMMENT 'Clave unica del registro de profesion',
  `nombre` varchar(50) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Nombre de la profesión ',
  `descripcion` longtext COLLATE utf8_spanish_ci NOT NULL COMMENT 'Descripción detallada del significado de la profesión  ',
  `estado` char(1) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Control de actividad o inactividad de la profesión, con valor de A o I '
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE `proyecto` (
  `id` int(11) NOT NULL COMMENT 'Clave unica de registro de proyecto',
  `asunto` varchar(100) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Breve descripción del proyecto, menos de 100 letras',
...
ALTER TABLE `estado`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_4786469191104EC2` (`id_pais`);
